    ...
    <section className="py-16 bg-blue-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-blue-100 text-lg">Three-layer verification ensures accuracy</p>
        </div>

        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-blue-800/50 backdrop-blur p-6 rounded-xl border border-blue-700 text-center md:text-center">
            ...
            <p className="text-sm text-blue-200 text-left md:text-center">Every statement must link to a source document location</p>
          </div>
          <div className="bg-blue-800/50 backdrop-blur p-6 rounded-xl border border-blue-700 text-center md:text-center">
            ...
            <p className="text-sm text-blue-200 text-left md:text-center">Multiple AI models verify each other's outputs</p>
          </div>
          <div className="bg-blue-800/50 backdrop-blur p-6 rounded-xl border border-blue-700 text-center md:text-center">
            ...
            <p className="text-sm text-blue-200 text-left md:text-center">Attorney reviews and approves before finalization</p>
          </div>
        </div>
      </div>
    </section>
