        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
            <div className="flex items-start gap-2 mb-3">
              ...
              <p className="text-sm text-slate-700 italic leading-relaxed">
                "We cut decision analysis time in half. Every finding includes the exact source location—critical for our review process."
              </p>
            </div>
            <p className="text-xs font-semibold text-slate-900">— Mid-sized VA practice</p>
            <p className="text-xs text-slate-500">3-attorney firm, East Coast</p>
          </div>
          ...
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
            <div className="flex items-start gap-2 mb-3">
              <span className="material-symbols-outlined text-blue-600">format_quote</span>
              <p className="text-sm text-slate-700 italic leading-relaxed">
                "The system doesn't guess. It shows us where it found the information. That credibility matters when we're building cases."
              </p>
            </div>
            <p className="text-xs font-semibold text-slate-900">— VSO Representative</p>
            <p className="text-xs text-slate-500">Regional office pilot</p>
          </div>
          ...
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
            <div className="flex items-start gap-2 mb-3">
              <span className="material-symbols-outlined text-blue-600">format_quote</span>
              <p className="text-sm text-slate-700 italic leading-relaxed">
                "Finally, AI that understands we need defensible outputs. The human review step keeps our quality standards intact."
              </p>
            </div>
            <p className="text-xs font-semibold text-slate-900">— Solo practitioner</p>
            <p className="text-xs text-slate-500">VA-accredited attorney</p>
          </div>
        </div>
